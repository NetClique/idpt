<?php
	...
	$sql_p2pFlow = "SELECT src_ip,dst_ip, class FROM flow_tbl WHERE class='P2P' ORDER BY RAND() LIMIT 20";
	$result_p2pFlow = mysql_query($sql_p2pFlow) or die("mysql output is zero". mysql_query());
	$column_cnt = mysql_num_fields($result_p2pFlow);	
	//echo $column_cnt;
        if($column_cnt > 0){
			print("<div align=center><br/><h3><b>Classification From Bayesian Network</p></b></h3><table cellpadding=5 width=30% border=1>");
